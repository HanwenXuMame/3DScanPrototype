...
namespace MVXUnity
{
    public abstract class MvxRemoteFileDataStreamDefinition : MvxDataStreamDefinition
    {
        ...
        /// <summary>
        /// Path to a file to which the downloader will write the cache to. If the path is relative, Application.temporaryCachePath is prepended.
        /// </summary>
        ...
        /// Filter events
        /// </summary>
        [SerializeField] public StreamEvents events;
