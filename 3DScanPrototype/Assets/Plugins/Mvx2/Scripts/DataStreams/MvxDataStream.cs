...
namespace MVXUnity
{
    public abstract class MvxDataStream : MonoBehaviour
    {
        ...
        /// <summary>
        /// Reinitializes stream asynchronously
        /// </summary>
        public Coroutine RestartStream()
        {
            IEnumerator Restart()
            {
        ...
        /// <summary>
        /// Restarts playback with current playback mode
        /// </summary>
