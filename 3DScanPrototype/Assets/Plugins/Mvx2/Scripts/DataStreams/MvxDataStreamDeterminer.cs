...
namespace MVXUnity
{
    ...
    public class MvxDataStreamDeterminer : MvxDataStream
    {
        ...
        internal override void ForceDisposeStream()
        {
            if (m_audioStream != null)
                m_audioStream.ForceDisposeStream();
            if (m_simpleStream != null)
                m_simpleStream.ForceDisposeStream();
        }
        ...
        public override void RestartPlayback()
        {
            if (m_audioStream != null)
            {
                m_audioStream.RestartPlayback();
                if (m_audioStream.isPaused)
                    m_audioStream.Resume();
            }
            if (m_simpleStream != null)
            {
                m_simpleStream.RestartPlayback();
                if (m_simpleStream.isPaused)
                    m_simpleStream.Resume();
            }
        }
