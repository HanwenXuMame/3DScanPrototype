...
namespace MVXUnity
{
    ...
    public class MvxAudioChunk
    {
        ...
        private UInt32 m_frameNr;
        public UInt32 frameNr
        {
            get { return m_frameNr; }
        }

        public MvxAudioChunk(float[] data, UInt32 channelsCount, UInt32 sampleRate, uint frameNr)
        {
            m_data = data;
        ...
        public MvxAudioChunk(byte[] data, UInt32 bytesPerSample, UInt32 channelsCount, UInt32 sampleRate, uint frameNr)
        {
        ...
        public void Reset(float[] newData, UInt32 newChannelsCount, UInt32 newSampleRate, uint frameNr)
        {
        ...
        public void Reset(byte[] newData, UInt32 bytesPerSample, UInt32 newChannelsCount, UInt32 newSampleRate, uint frameNr)
        {
