...
namespace MVXUnity
{
    ...
    public class MvxAudioAsyncPlayer : MvxAsyncDataProcessor
    {
        ...
        unsafe private void ProcessAudioData(Mvx2API.Frame frame)
        {
            ...
            MvxAudioChunk newAudioChunk = MvxAudioChunksPool.instance.AllocateAudioChunk(frameAudioBytes, frameBytesPerSample, frameChannelsCount, frameSampleRate, frame.GetStreamAtomNr());
            lock (m_audioPlayer)
