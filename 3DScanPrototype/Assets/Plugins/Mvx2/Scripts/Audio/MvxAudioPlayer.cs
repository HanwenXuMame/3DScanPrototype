...
namespace MVXUnity
{
    public class MvxAudioPlayer
    {
        ...
        /// <returns> Frame number of dequeued frame. Null if none. </returns>
        public uint? DequeueAudioData(float[] targetData, int targetChannelsCount, int targetSampleRate)
        {
            ...
            lock (m_audioChunksQueue)
            {
                ...
                return currentAudioChunk.frameNr;
            }
        }
